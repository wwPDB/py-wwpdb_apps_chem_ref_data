...
class ChemRefSearchDef(object):
    ...
    _searchTypeDict = {
        'BIRD_FAMILY_ID': {'queryColList': ['pdbx_reference_molecule_list.family_prd_id'],
                           'logicalOp': 'AND',
                           'extraConditions': '',
                           'orderByList': [],
                           'resourceId': 'PRD',
        ...
        'BIRD_PRD_ID': {'queryColList': ['pdbx_reference_molecule.prd_id'],
                        'logicalOp': 'AND',
                        'extraConditions': '',
                        'orderByList': [],
                        'resourceId': 'PRD',
        ...
        'BIRD_NAME': {'queryColList': ['pdbx_reference_molecule.name'],
                      'logicalOp': 'AND',
                      'extraConditions': '',
                      'orderByList': [],
                      'resourceId': 'PRD',
        ...
        'BIRD_SYNONYM': {'queryColList': ['pdbx_reference_molecule_synonyms.name'],
                         'logicalOp': 'AND',
                         'extraConditions': '',
                         'orderByList': [],
                         'resourceId': 'PRD',
        ...
        'BIRD_NAME_OR_SYNONYM': {'queryColList': ['pdbx_reference_molecule.name', 'pdbx_reference_molecule_synonyms.name'],
                                 'logicalOp': 'OR',
                                 'extraConditions': '',
                                 'orderByList': [],
                                 'resourceId': 'PRD',
        ...
        'BIRD_CC_ID': {'queryColList': ['pdbx_reference_molecule.chem_comp_id'],
                       'logicalOp': 'AND',
                       'extraConditions': '',
                       'orderByList': [],
                       'resourceId': 'PRD',
        ...
        'BIRD_TYPE': {'queryColList': ['pdbx_reference_molecule.type'],
                      'logicalOp': 'AND',
                      'extraConditions': '',
                      'orderByList': [],
                      'resourceId': 'PRD',
        ...
        'BIRD_CLASS': {'queryColList': ['pdbx_reference_molecule.class'],
                       'logicalOp': 'AND',
                       'extraConditions': '',
                       'orderByList': [],
                       'resourceId': 'PRD',
        ...
        'BIRD_FORMULA': {'queryColList': ['pdbx_reference_molecule.formula'],
                         'logicalOp': 'AND',
                         'extraConditions': '',
                         'orderByList': [],
                         'resourceId': 'PRD',
        ...
        'BIRD_SEQ_ONE_LETTER_CODE': {'queryColList': ['pdbx_reference_entity_sequence.one_letter_codes'],
                                     'logicalOp': 'AND',
                                     'extraConditions': '',
                                     'orderByList': [],
                                     'resourceId': 'PRD',
        ...
        'BIRD_SEQ_THREE_LETTER_CODE': {'queryColList': ['pdbx_reference_entity_sequence_list.three_letter_codes'],
                                       'logicalOp': 'AND',
                                       'extraConditions': '',
                                       'orderByList': [],
                                       'resourceId': 'PRD',
        ...
        'BIRD_SOURCE_ORGANISN_NAME': {'queryColList': ['pdbx_reference_entity_src_nat.organism_scientific'],
                                      'logicalOp': 'AND',
                                      'extraConditions': '',
                                      'orderByList': [],
                                      'resourceId': 'PRD',
        ...
        'BIRD_SUBCOMPONENTS': {'queryColList': ['pdbx_reference_entity_subcomponents.seq'],
                               'logicalOp': 'AND',
                               'extraConditions': '',
                               'orderByList': [],
                               'resourceId': 'PRD',
        ...
        'BIRDINST_PRD_ID_PUBLIC': {'queryColList': ['da_internal_combine.pdbx_molecule_features.prd_id'],
                                   'logicalOp': 'AND',
                                   'extraConditions': ' (da_internal_combine.rcsb_status.status_code = "REL") ',
                                   'orderByList': ['da_internal_combine.pdbx_molecule_features.prd_id', 'da_internal_combine.rcsb_status.status_code', 'da_internal_combine.pdbx_molecule_features.Structure_ID'],
                                   'resourceId': 'DA_INTERNAL_COMBINE',
                                   'displayType': 'birdSummaryResultsInstancePublic',
                                   'displayTitle': 'BIRD instances in public entries',
                                   },
        'BIRDINST_PRD_ID_INTERNAL': {'queryColList': ['da_internal_combine.pdbx_molecule_features.prd_id'],
                                     'logicalOp': 'AND',
                                     'extraConditions': ' (da_internal_combine.rcsb_status.status_code != "REL") ',
                                     'orderByList': ['da_internal_combine.pdbx_molecule_features.prd_id', 'da_internal_combine.rcsb_status.status_code', 'da_internal_combine.pdbx_molecule_features.Structure_ID'],
                                     'resourceId': 'DA_INTERNAL_COMBINE',
        ...
        'CCD_CC_ID': {'queryColList': ['chem_comp.Component_id'],
                      'logicalOp': 'AND',
                      'extraConditions': '',
                      'orderByList': [],
                      'resourceId': 'CC',
        ...
        'CCD_NAME': {'queryColList': ['chem_comp.name'],
                     'logicalOp': 'AND',
                     'extraConditions': '',
                     'orderByList': [],
                     'resourceId': 'CC',
        ...
        'CCD_SYNONYM': {'queryColList': ['chem_comp.pdbx_synonyms'],
                        'logicalOp': 'AND',
                        'extraConditions': '',
                        'orderByList': [],
                        'resourceId': 'CC',
        ...
        'CCD_NAME_OR_SYNONYM': {'queryColList': ['chem_comp.name', 'chem_comp.pdbx_synonyms'],
                                'logicalOp': 'OR',
                                'extraConditions': '',
                                'orderByList': [],
                                'resourceId': 'CC',
        ...
        'CCD_FORMULA': {'queryColList': ['chem_comp.formula'],
                        'logicalOp': 'AND',
                        'extraConditions': '',
                        'orderByList': [],
                        'resourceId': 'CC',
        ...
        'CCD_FORMULA_WEIGHT': {'queryColList': ['chem_comp.formula_weight'],
                               'logicalOp': 'AND',
                               'extraConditions': '',
                               'orderByList': [],
                               'resourceId': 'CC',
        ...
        'CCD_SUBCOMPONENTS': {'queryColList': ['chem_comp.pdbx_subcomponent_list'],
                              'logicalOp': 'AND',
                              'extraConditions': '',
                              'orderByList': [],
                              'resourceId': 'CC',
        ...
        'CCDINST_CC_ID_PUBLIC': {'queryColList': ['da_internal_combine.chem_comp.id'],
                                 'logicalOp': 'AND',
                                 'extraConditions': ' (da_internal_combine.rcsb_status.status_code = "REL") ',
        ...
        'CCDINST_CC_ID_INTERNAL': {'queryColList': ['da_internal_combine.chem_comp.id'],
                                   'logicalOp': 'AND',
                                   'extraConditions': ' (da_internal_combine.rcsb_status.status_code != "REL") ',
                                   'orderByList': ['da_internal_combine.chem_comp.id', 'da_internal_combine.rcsb_status.status_code', 'da_internal_combine.rcsb_status.Structure_ID'],
                                   'resourceId': 'DA_INTERNAL_COMBINE',
        ...
        'CCDIDX_FORMULA': {'queryColList': ['formula'],
                           'logicalOp': 'AND',
                           'extraConditions': '',
                           'orderByList': [],
                           'resourceId': None,
        ...
        'CCDIDX_FORMULA_BOUNDED': {'queryColList': ['formula'],
                                   'logicalOp': 'AND',
                                   'extraConditions': '',
                                   'orderByList': [],
                                   'resourceId': None,
        ...
        'CCDIDX_FORMULA_SUBSET': {'queryColList': ['formula'],
                                  'logicalOp': 'AND',
                                  'extraConditions': '',
                                  'orderByList': [],
                                  'resourceId': None,
        ...
        'CCDIDX_FORMULA_HEAVY_ATOM_EXACT': {'queryColList': ['formula'],
                                            'logicalOp': 'AND',
                                            'extraConditions': '',
                                            'orderByList': [],
                                            'resourceId': None,
        ...
        'CCDIDX_FORMULA_EXACT': {'queryColList': ['formula'],
                                 'logicalOp': 'AND',
                                 'extraConditions': '',
                                 'orderByList': [],
                                 'resourceId': None,
        ...
        'CCDIDX_FORMULA_WEIGHT_RANGE': {'queryColList': ['formulaWeight'],
                                        'logicalOp': 'AND',
                                        'extraConditions': '',
                                        'orderByList': [],
                                        'resourceId': None,
        ...
        'CCDIDX_INCHI': {'queryColList': ['InChI'],
                         'logicalOp': 'AND',
                         'extraConditions': '',
                         'orderByList': [],
                         'resourceId': None,
        ...
        'CCDIDX_INCHIKEY': {'queryColList': ['InChIKey'],
                            'logicalOp': 'AND',
                            'extraConditions': '',
                            'orderByList': [],
                            'resourceId': None,
        ...
        'CCDIDX_INCHIKEY14': {'queryColList': ['InChIKey14'],
                              'logicalOp': 'AND',
                              'extraConditions': '',
                              'orderByList': [],
                              'resourceId': None,
        ...
        'CCDIDX_SUBCOMPONENTS': {'queryColList': ['subcomponentList'],
                                 'logicalOp': 'AND',
                                 'extraConditions': '',
                                 'orderByList': [],
                                 'resourceId': None,
        ...
        'CCDIDX_SUBCOMPONENT_SUBSET': {'queryColList': ['subcomponentList'],
                                       'logicalOp': 'AND',
                                       'extraConditions': '',
                                       'orderByList': [],
                                       'resourceId': None,
        ...
        'CCDIDX_SMILES': {'queryColList': ['smilesList'],
                          'logicalOp': 'AND',
                          'extraConditions': '',
                          'orderByList': [],
                          'resourceId': None,
        ...
        'CCDIDX_SMILES_STEREO': {'queryColList': ['smilesList'],
        ...
        'CCDIDX_SIMILAR_NAME': {'queryColList': ['nameList'],
                                'logicalOp': 'AND',
                                'extraConditions': '',
                                'orderByList': [],
                                'resourceId': None,
