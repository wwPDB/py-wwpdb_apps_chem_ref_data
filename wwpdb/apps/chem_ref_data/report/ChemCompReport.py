...
class ChemCompReport(object):
    ...
    def doReport(self):
        ...
        blockId = self.__ccId
        #
        logger.info("+ChemCompReport.doReport()  - Starting doReport() \n")
        logger.info("+ChemCompReport.doReport()  - file path    %s\n" % filePath)
        logger.info("+ChemCompReport.doReport()  - file format  %s\n" % fileFormat)
        logger.info("+ChemCompReport.doReport()  - block Id     %s\n" % blockId)
        #
        #
        ...
        if (filePath != localPath):
            ...
            logger.info("+ChemCompReport.doReport() - Copied input file %s to report session path %s \n"
                        % (filePath, localPath))
        #
        # Path context --
        ...
        try:
            ...
            if (self.__verbose):
                logger.info("+ChemCompReport.doReport() - category name list %r \n" % ccR.getCurrentCategoryNameList())
